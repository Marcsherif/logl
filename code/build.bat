...
set includeDirs= /I %rootDir%\ext\sdl3\include /I %rootDir%\ext\glad\include /I %rootDir%\ext\glad\src\ /I %rootDir%\ext\stb_image\include /I %rootDir%\ext\glm\include /I %rootDir%\ext\cgltf\include
...
cl %compilerFlags% ..\code\logl_main.cpp %includeDirs% /link %linkDirs% %linkerFlags%
